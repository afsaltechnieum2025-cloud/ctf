  ...
  return (
    <>
      ...
      >
        {/* Logo Header */}
        <div className={cn(
          "flex items-center border-b border-border/50 p-3 min-h-[56px]",
          collapsed ? "justify-center" : "justify-between"
        )}>
          {!collapsed && (
            <Link to="/dashboard" className="flex items-center justify-evenly gap-2 flex-1 min-w-0">
              <img
                src={logo}
                alt="Technieum"
                className="h-8 w-auto max-w-[9.5rem] object-contain object-left shrink-0"
              />
